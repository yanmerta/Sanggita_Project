            ...
            <div class="card-body">
                <div id="kt_content_container" class="container-xxl">
                    <div class="row gy-5 g-xl-10">
                        <div class="col-md-3">
                            <div class="card card-flush h-xl-50" style="background-color: #cde7fde8">
                                <!--begin::Header-->
                        ...
                        <div class="col-xxl-8">
                            ...
                            <div class="card card-flush overflow-hidden h-xl-100 bg-light-primary">
                                ...
                                <div class="card-header pt-7 mb-2">
                                    ...
                                    <a href="#" class="btn btn-success flex-shrink-0 me-2" data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">Pengajuan</a>
                                    <a href="#" class="btn btn-success flex-shrink-0 me-2" data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">Persetujuan</a>
                                    <a href="#" class="btn btn-success flex-shrink-0 me-2" data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">Realisasi</a>
                                    <a href="#" class="btn btn-success flex-shrink-0 me-2" data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">Pelaporan</a>
                                </div>
                                <!--end::Header-->
                                <!--begin::Card body-->
