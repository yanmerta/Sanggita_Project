...
=======
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
                        ...
                        <div class="d-flex flex-column bgi-no-repeat rounded-top"
                            style="background-image:url('/html/demo1/dist/assets/media/misc/pattern-1.jpg')">
                            <!--begin::Title-->
                                ...
                                <div class="d-flex flex-column px-9">
                                    ...
                                    <div class="text-center px-4">
                                        <img class="mw-100 mh-200px" alt="image"
                                            src="/html/demo1/dist/assets/media/illustrations/sketchy-1/1.png" />
                                    </div>
                                    <!--end::Illustration-->
                                </div>
                                <!--end::Wrapper-->
...
>>>>>>> b36c92e82cf9bef0cec20cbdbdd1b34c21f52626
                <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click"
                        ...
                        @if (auth()->user()->photo)
                            <!-- Jika pengguna memiliki foto profil, gunakan foto itu -->
                            <img src="{{ asset('storage/photos/' . auth()->user()->photo) }}" alt="user" />
                        @else
                            <!-- Jika tidak, gunakan avatar default atau gambar lainnya -->
                            <img src="/html/demo1/dist/assets/media/avatars/blank.png" alt="user" />
                        @endif
                    </div>
                                ...
                                <div class="symbol symbol-50px me-5">
                                    @if (auth()->user()->photo)
                                        ...
                                        <img src="{{ asset('storage/photos/' . auth()->user()->photo) }}"
                                            alt="user" width="10" height="10" />
                                    @else
                                        <!-- Jika tidak, gunakan avatar default atau gambar lainnya -->
                                        <img alt="Logo" src="/html/demo1/dist/assets/media/avatars/blank.png" />
                                    @endif
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Username-->
...
>>>>>>> b36c92e82cf9bef0cec20cbdbdd1b34c21f52626
                        ...
                        <div class="menu-item px-5" data-kt-menu-trigger="hover"
                                ...
                                <span class="menu-title position-relative">Language
                                    {{-- <span
                                        ...
                                        <img class="w-15px h-15px rounded-1 ms-2"
                                            src="/html/demo1/dist/assets/media/flags/indonesia.svg" alt="" />
                                    </span> --}}
                                </span>
                            </a>
                            <!--begin::Menu sub-->
                            <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{ route('locale', ['locale' => 'id']) }}" class="menu-link d-flex px-5"
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{ route('locale', ['locale' => 'en']) }}" class="menu-link d-flex px-5"
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{ route('locale', ['locale' => 'jp']) }}" class="menu-link d-flex px-5"
                                        style="{{ session()->get('locale') == 'jp' ? 'background-color: rgb(255,209,209)' : '' }}">
                                        <span class="symbol symbol-20px me-4">
                                            <img class="rounded-1" src="/html/demo1/dist/assets/media/flags/japan.svg"
                                                alt="" />
                                        </span>Japan</a>
                                </div>
                            </div>
                            ...
                            <div class="menu-content px-5">
                                <form action="{{ route('create-update') }}" method="post" class="d-flex">
                                    ...
                                    {{-- <input type="radio" name="theme" id="theme" value="dark"
                                        class="btn-check" onchange="this.from.submit()">
                                    <label for="theme" class="btn btn-secondary">
                                        <i class="">Mode</i>
                                    </label> --}}
                                    <label for="theme"
                                        class="form-check form-switch form-check-custom form-check-solid pulse pulse-success">
                                        <input class="form-check-input w-30px h-20px" type="checkbox" name="theme"
                                            id="theme" value="dark" onchange="this.from.submit()" />
